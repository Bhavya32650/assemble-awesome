// Classic Fisher Iris dataset — 150 samples, 4 features, 3 classes.
// Order: [sepalLength, sepalWidth, petalLength, petalWidth, class]
...
const raw: [number, number, number, number, IrisClass][] = [
...
export const IRIS: IrisSample[] = raw.map(([sl, sw, pl, pw, cls]) => ({ sl, sw, pl, pw, cls }));

export const CLASSES: IrisClass[] = ["setosa", "versicolor", "virginica"];

export const CLASS_COLORS: Record<IrisClass, string> = {
  setosa: "#22d3ee",
  versicolor: "#a78bfa",
  virginica: "#fb923c",
};
